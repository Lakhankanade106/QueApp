     ...
     <SafeAreaView style={{flex:1,backgroundColor:'#F9F6F6'}}>
         <View style={{flexDirection:'row',width:'100%',marginTop:20}}>
            ...
            <View style={{alignItems:'center',width:'80%'}}>
                <Text style={{fontSize:16,fontWeight:'bold'}}>Banking List</Text>
            </View>
        </View>
         <ScrollView horizontal={true} style={{flex:1}}>
             <View style={{flex:1}}>
                 <View style={{flexDirection:'row',borderWidth:0.5,paddingBottom:10,paddingTop:10,marginTop:15,justifyContent:'space-around'}}>
                   ...
                   <Text style={[styles.Header_Text,{width:100}]}>Returned By</Text>
                   <Text style={[styles.Header_Text,{width:150}]}>Transaction Id</Text>
                   <Text style={[styles.Header_Text,{width:120}]}>Description</Text>
                   <Text style={[styles.Header_Text,{width:100,marginRight:15}]}>Screenshot</Text>
                   <Text style={[styles.Header_Text,{width:100}]}>Date</Text>
                   <Text style={[styles.Header_Text,{width:100}]}>Status</Text>
                 </View>
                 <View style={{flex:1}}>
                   ...
                   <FlatList 
                       ...
                       <View style={{borderBottomWidth:0.5,marginTop:5}}>
                         <View style={{flexDirection:'row',justifyContent:'space-around'}}>
                            ...
                            <Text style={{width:100,alignSelf:'center'}}>{item.returned_by}</Text>
                            <Text style={{width:150,alignSelf:'center'}}>{item.transaction_id}</Text>
                            <Text style={{width:120,alignSelf:'center'}}>{item.description}</Text>
                            ...
                            <Text style={{width:100,alignSelf:'center'}}>{item.date}</Text>
                            <Text style={{width:100,alignSelf:'center'}}>{item.status}</Text>
                         </View>
                       </View>
                     }
                   />
